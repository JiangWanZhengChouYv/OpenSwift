...
OpenSwift can be extended through **plugins** without modifying the main app. The full development guide — `manifest.yml` syntax, supported L1 controls, the `openSwift.*` script API, and distribution — is in **[DevelopingPlugins.md](DevelopingPlugins.md)**.

> Reference implementation: `plugin/test/startup_fixed_speed/`.
